...
void main() {
  testWidgets('shows passed body and bar', (tester) async {
    await tester.pumpWidget(await materialApp(const FullscreenDialog(
  ...
  testWidgets('close button pops scope', (tester) async {
    ...
    await tester.pumpWidget(await materialApp(PopScope(
  ...
  testWidgets('action FAB callback works', (tester) async {
    ...
    await tester.pumpWidget(await materialApp(FullscreenDialog(
      actionButtonText: 'BTN',
      actionAsFab: true,
