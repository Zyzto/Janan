...
sealed class EntryParsingError {
  ...
  String localize() => switch (this) {
    RecordParsingErrorEmptyFile() => 'errParseEmptyCsvFile'.tr(),
    RecordParsingErrorTimeNotRestoreable() => 'errParseTimeNotRestoreable'.tr(),
    RecordParsingErrorUnknownColumn() => 'errParseUnknownColumn'.tr(
        namedArgs: {'title': (this as RecordParsingErrorUnknownColumn).title},
      ),
    RecordParsingErrorExpectedMoreFields() => 'errParseLineTooShort'.tr(
        namedArgs: {
          'lineNumber': '${(this as RecordParsingErrorExpectedMoreFields).lineNumber}',
        },
      ),
    RecordParsingErrorUnparsableField() => 'errParseFailedDecodingField'.tr(
        namedArgs: {
          'lineNumber': '${(this as RecordParsingErrorUnparsableField).lineNumber}',
          'fieldContent': (this as RecordParsingErrorUnparsableField).fieldContents,
        },
      ),
  };
}
