...
class IntervalStorage extends ChangeNotifier {
  ...
  /// How far the user paged from the most recent interval.
  int get directionalStep => _directionalStep;
  ...
  DateRange get currentRange => rangeAt(_directionalStep);

  /// Display range if the user had paged by [directionalStep].
  DateRange rangeAt(int directionalStep) {
