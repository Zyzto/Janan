  ...
  Widget build(BuildContext context) {
    ...
    final searchField = showSearch
        ? TextField(
            ...
            decoration: InputDecoration(
              hintText: localizations.searchDevices,
    ...
    final list = noMatches
        ? Padding(
            ...
            child: Text(
              localizations.noMatchingDevices,
            ...
            children: [
              ...
              if (other.isNotEmpty)
                ExpansionTile(
                  ...
                  title: Text(
                    '${localizations.showOtherDevices} (${other.length})',
                  ),
                  children: [
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.isScanning) ...[
              const SizedBox(height: 12),
              _ScanningStatus(label: localizations.scanningForDevices),
            ],
    ...
    return InputCard(
      title: Text(localizations.availableDevices),
      child: Column(
