...
class BleHomeSyncIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Tooltip(
        message: view?.paused == true
            ? localizations.meterSyncPaused
            : _tooltip(progress, localizations),
        child: InkWell(
  ...
  static String _tooltip(
    ...
    if (result != null) {
      return switch (result.status) {
        ...
        BleLaunchSyncStatus.skipped => localizations.meterNotFound,
      };
    }
